...
using TicTacToe.Infrastructure.Editor;
...
namespace TicTacToe.Presentation.UiToolkit {
    public class TicTacToeWindow : EditorWindow {
        private readonly Vector2Int _dimensions = new Vector2Int(640, 960);
        ...
        private void CreateGUI() {
            ...
            this.minSize = new Vector2(_dimensions.x, _dimensions.y);
